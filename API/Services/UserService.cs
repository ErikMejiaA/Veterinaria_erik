...
public class UserService : IUserServiceInterface
{
        ...
        if (resultado == PasswordVerificationResult.Success)
        {
            ...
            if (rolExiste !=null)
            {
                var usuarioTieneRol = usuario.Roles
                                                .Any(u => u.IdCodigo == rolExiste.IdCodigo);
    ...
    //ACTUALIZACION DEL TOKEN POR MEDIO DEL REFRESTOKEN 
    ...
    private JwtSecurityToken CreateJwtToken(Usuario usuario)
    {
        ...
        var claims = new[]
        {
                ...
                new Claim("uid", usuario.IdCodigo.ToString())
        }
        .Union(roleClaims);
    ...
    public async Task<Usuario> EditarUsuarioAsync(Usuario model)
    {
        ...
        usuario.IdCodigo = model.IdCodigo;
